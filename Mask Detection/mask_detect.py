...
while True:
	...
	try:
		...
		print("[ERROR] Check you camera connection.")
		break
	...
	for (box, pred) in zip(locs, preds):
		...
		if mask > withoutMask:
			...
			for encode_current, face_current in zip(encode_current_face, face_location):
				face_match = fr.compare_faces(encode_current, encodes.en ,tolerance=0.7)
				...
				if face_match[index_match]:
					...
					# message.msg(name)
					cv2.rectangle(frame, (face_current[3] * 4, face_current[0] * 4),
								  (face_current[1] * 4, face_current[2] * 4), (00, 00, 255), 5)
					cv2.putText(frame, name, (face_current[3] * 4, face_current[2] * 4 - 150),cv2.FONT_HERSHEY_SIMPLEX,1, (0, 255, 0,), 2)

				else:

					cv2.rectangle(frame, (face_current[3] * 4, face_current[0] * 4),(face_current[1] * 4, face_current[2] * 4), (00, 00, 255), 5)
					cv2.putText(frame, "Invalid Person", (face_current[3] * 4, face_current[2] * 4 + 20),cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255,), 2)
